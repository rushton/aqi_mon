...
void loop() {
  ...
  Serial.print(F(",\"particles_03um\":"));
  Serial.print(data.particles_03um);
  Serial.print(F(",\"particles_05um\":"));
  Serial.print(data.particles_05um);
  Serial.print(F(",\"particles_10um\":"));
  Serial.print(data.particles_10um);
  Serial.print(F(",\"particles_25um\":"));
  Serial.print(data.particles_25um);
  Serial.print(F(",\"particles_50um\":"));
  Serial.print(data.particles_50um);
  Serial.print(F(",\"particles_100um\":"));
